...
if (!in_array("addAsset", $_SESSION['PERMISSIONS'])) {
                        ...
                        <form action="" class="form-horizontal" id ="asset_form">
                          ...
                          <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type ="text" name ="amountpurchased" id ="amountpurchased" data-required="true" data-type ="number">
                                </div>
                            </div>                            
                            <div class="control-group">
    ...
    $(document).ready(function(){
        ...
        $("#savebtn").click(function(){
            if($('#asset_form').parsley( 'validate' )){
                $.ajax({
                    type: "POST",
                    url: "server/asset_create_exec.php",
