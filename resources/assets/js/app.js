var App = function () {
    ...
    // this fnction handles responsive layout on screen size resize or mobile device rotate.
    ...
    var handleSidebarToggler = function () {
        ...
        $('.page-sidebar .sidebar-toggler').live("click",function () {
        ...
        $('.sidebar-search .remove').live("click",function () {
            $('.sidebar-search').removeClass("open");
        });
...
//        });
    ...
    var handleStyler = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "../../resources/assets/css/style_" + color + ".css");
        }
